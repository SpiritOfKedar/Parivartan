...
export const mr: Messages = {
  ...
  nav: {
    ...
    menu: {
      ...
      editImage: "संपादन",
      enhanceImage: "सुधारणा",
      convertImage: "रूपांतर",
      toPdf: "PDF मध्ये रूपांतर",
      fromPdf: "PDF मधून रूपांतर",
      videoTools: "व्हिडिओ साधने",
      audioTools: "ऑडिओ साधने",
    },
  },
  hero: {
    ...
    line2After: " ते सर्व.",
    body: "प्रतिमा, PDF, व्हिडिओ आणि ऑडिओसाठी प्रीमियम साधने. जलद, खाजगी आणि मोफत.",
    imageAlt: "उन्हाळ्याच्या कुरणात ढगांखाली विश्रांती घेतलेली व्यक्ती",
    scrollHint: "साधने पहा",
  },
  footer: {
  ...
  tools: {
    ...
    "edit-pdf": {
      ...
      description:
        "PDF पृष्ठांवर मजकूर ओव्हरले जोडा.",
    },
    "watermark-pdf": {
      name: "PDF वॉटरमार्क",
    ...
    "resize-image": {
      ...
      description:
        "पिक्सेल किंवा टक्केवारीने प्रतिमेचे परिमाण बदला.",
    },
    "crop-image": {
    ...
    "convert-to-jpg": {
      ...
      description:
        "PNG, GIF, WebP आणि इतर प्रतिमा JPG मध्ये बदला.",
    },
    "convert-from-jpg": {
    ...
    "photo-editor": {
      name: "फोटो संपादक",
      description:
        "क्रॉप, फिरवा, रंग समायोजित करा, मजकूर जोडा, रेखाटा आणि फिल्टर लावा.",
    },
    "upscale-image": {
      name: "प्रतिमा अपस्केल",
      description:
        "AI सुपर-रेझोल्यूशनने २× किंवा ४× रेझोल्यूशन.",
    },
    "remove-background": {
      name: "पार्श्वभूमी काढा",
      description:
        "पार्श्वभूमी आपोआप काढा आणि पारदर्शक PNG निर्यात करा.",
    },
    "watermark-image": {
    ...
    "meme-generator": {
      name: "मीम जनरेटर",
      description:
        "क्लासिक वरच्या आणि खालच्या मीम मजकुराने प्रतिमेला मथळा द्या.",
    },
    "rotate-image": {
      name: "प्रतिमा फिरवा",
      description:
        "JPG, PNG, WebP किंवा GIF ९०°, १८०° किंवा २७०° ने फिरवा.",
    },
    "html-to-image": {
    ...
    "blur-faces": {
      ...
      description:
        "गोपनीयतेसाठी चेहरे शोधा आणि अस्पष्ट करा.",
    },
    "merge-audio": {
      name: "ऑडिओ विलीन करा",
      description:
